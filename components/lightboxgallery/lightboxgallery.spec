{
	...
	"model":
	{
		"imagesFoundset"			: { "type": "foundset", "initialPreferredViewPortSize": 5, "dataproviders": ["image", "caption", "thumbnail", "imageId"], "tags": { "doc": "Component needs dataproviders from the foundset for the following: imageId, image, caption and thumbnail.", "basic": true} },
		...
		"imagesDataset"             : { "type": "image[]", "pushToServer": "deep","tags": { "basic": true } }
	},
	"api": {
		"showLightbox": {
			"parameters": [
