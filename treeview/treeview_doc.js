...
var svy_types = {
    /**
     * Event object for drag and drop operations.
     */
    JSDNDEvent: {
        /**
         * The name of the source grid involved in the drag and drop operation.
         * @type {String}
         */
        sourceGridName: null,
        
        /**
         * The ID of the source column involved in the drag and drop operation.
         * @type {String}
         */
        sourceColumnId: null
    }
 ...
 * 
 * @param {Number} nodeId The identifier of the node to scroll to.
 */
