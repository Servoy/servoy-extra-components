...
- Understand the dual-layer architecture:
  ...
  - Angular implementation (`components/projects/servoyextracomponents/src/<name>/`)
...
Example: `docs/SVY-21080-sidenav-collapse-animation.spec.md`
...
```
docs/SVY-21080-sidenav-collapse-animation.spec.md
```
