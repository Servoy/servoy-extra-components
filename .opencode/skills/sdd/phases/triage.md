...
- The Angular implementation (`components/projects/servoyextracomponents/src/<name>/`)
...
```powershell
cd "C:\Users\jcomp\git\servoy-extra-components" ; git blame -L <start>,<end> "<file-path>"
...
- **Is the problem even in Servoy component code?** Or is it user-side (misconfiguration,
  ...
  (`@servoy/public`, `@ng-bootstrap`, etc.)?
