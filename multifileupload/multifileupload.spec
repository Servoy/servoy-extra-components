{
    ...
    "model": {
        ...
        "inline": 						{ "type": "boolean", "default": true, "tags": { "doc": "When false, the component does not show on the form, but in a modal that is shown when openModal() is called. Should not be used together with closeAfterFinish (so both properties to be true)" } },
        "note": 						{ "type": "tagstring" },
